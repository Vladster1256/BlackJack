...
containing a value of this type.
 ...
 The platform's desired fixed width for a dialog along the minor axis
    ...
    public static final class drawable {
        ...
        public static final int poker=0x7f020058;
    }
 ...
 The maximum number of action buttons that should be permitted within
    ...
    public static final class layout {
        ...
        public static final int activity_title_screen=0x7f030019;
 ...
 Attributes used to style the Action Bar.
         ...
         namespace prefix and once without. 
           ...
           <tr><td><code>{@link #ActionBar_background ctec.example.blackjack:background}</code></td><td> Specifies a background drawable for the action bar.</td></tr>
           <tr><td><code>{@link #ActionBar_backgroundSplit ctec.example.blackjack:backgroundSplit}</code></td><td> Specifies a background drawable for the bottom component of a split action bar.</td></tr>
           <tr><td><code>{@link #ActionBar_backgroundStacked ctec.example.blackjack:backgroundStacked}</code></td><td> Specifies a background drawable for a second stacked row of the action bar.</td></tr>
           <tr><td><code>{@link #ActionBar_customNavigationLayout ctec.example.blackjack:customNavigationLayout}</code></td><td> Specifies a layout for custom navigation.</td></tr>
           <tr><td><code>{@link #ActionBar_displayOptions ctec.example.blackjack:displayOptions}</code></td><td> Options affecting how the action bar is displayed.</td></tr>
           <tr><td><code>{@link #ActionBar_divider ctec.example.blackjack:divider}</code></td><td> Specifies the drawable used for item dividers.</td></tr>
           <tr><td><code>{@link #ActionBar_height ctec.example.blackjack:height}</code></td><td> Specifies a fixed height.</td></tr>
           <tr><td><code>{@link #ActionBar_homeLayout ctec.example.blackjack:homeLayout}</code></td><td> Specifies a layout to use for the "home" section of the action bar.</td></tr>
           <tr><td><code>{@link #ActionBar_icon ctec.example.blackjack:icon}</code></td><td> Specifies the drawable used for the application icon.</td></tr>
           <tr><td><code>{@link #ActionBar_indeterminateProgressStyle ctec.example.blackjack:indeterminateProgressStyle}</code></td><td> Specifies a style resource to use for an indeterminate progress spinner.</td></tr>
           <tr><td><code>{@link #ActionBar_itemPadding ctec.example.blackjack:itemPadding}</code></td><td> Specifies padding that should be applied to the left and right sides of
             system-provided items in the bar.</td></tr>
           <tr><td><code>{@link #ActionBar_logo ctec.example.blackjack:logo}</code></td><td> Specifies the drawable used for the application logo.</td></tr>
           <tr><td><code>{@link #ActionBar_navigationMode ctec.example.blackjack:navigationMode}</code></td><td> The type of navigation to use.</td></tr>
           <tr><td><code>{@link #ActionBar_progressBarPadding ctec.example.blackjack:progressBarPadding}</code></td><td> Specifies the horizontal padding on either end for an embedded progress bar.</td></tr>
           <tr><td><code>{@link #ActionBar_progressBarStyle ctec.example.blackjack:progressBarStyle}</code></td><td> Specifies a style resource to use for an embedded progress bar.</td></tr>
           <tr><td><code>{@link #ActionBar_subtitle ctec.example.blackjack:subtitle}</code></td><td> Specifies subtitle text used for navigationMode="normal" </td></tr>
           <tr><td><code>{@link #ActionBar_subtitleTextStyle ctec.example.blackjack:subtitleTextStyle}</code></td><td> Specifies a style to use for subtitle text.</td></tr>
           <tr><td><code>{@link #ActionBar_title ctec.example.blackjack:title}</code></td><td> Specifies title text used for navigationMode="normal" </td></tr>
           <tr><td><code>{@link #ActionBar_titleTextStyle ctec.example.blackjack:titleTextStyle}</code></td><td> Specifies a style to use for title text.</td></tr>
           </table>
...
or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
        ...
        */
        ...
        /**  Valid LayoutParams for views placed in the action bar as custom views. 
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #ActionBarLayout_android_layout_gravity ctec.example.blackjack:android_layout_gravity}</code></td><td></td></tr>
           </table>
        ...
        /**
          <p>This symbol is the offset where the {@link ctec.example.blackjack.R.attr#android_layout_gravity}
        ...
        */
        ...
        /**  These attributes are meant to be specified and customized by the app.
         ...
         be present and whether it should overlay content. 
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #ActionBarWindow_windowActionBar ctec.example.blackjack:windowActionBar}</code></td><td></td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowActionBarOverlay ctec.example.blackjack:windowActionBarOverlay}</code></td><td></td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMajor ctec.example.blackjack:windowFixedHeightMajor}</code></td><td> A fixed height for the window along the major axis of the screen,
             that is, when in portrait.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMinor ctec.example.blackjack:windowFixedHeightMinor}</code></td><td> A fixed height for the window along the minor axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMajor ctec.example.blackjack:windowFixedWidthMajor}</code></td><td> A fixed width for the window along the major axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMinor ctec.example.blackjack:windowFixedWidthMinor}</code></td><td> A fixed width for the window along the minor axis of the screen,
             that is, when in portrait.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowSplitActionBar ctec.example.blackjack:windowSplitActionBar}</code></td><td></td></tr>
           </table>
        ...
        /**
          <p>This symbol is the offset where the {@link ctec.example.blackjack.R.attr#windowActionBar}
...
containing a value of this type.
        ...
        */
        ...
        /**
          <p>This symbol is the offset where the {@link ctec.example.blackjack.R.attr#windowActionBarOverlay}
          attribute's value can be found in the {@link #ActionBarWindow} array.
...
containing a value of this type.
        ...
        */
        ...
        /**
          <p>This symbol is the offset where the {@link ctec.example.blackjack.R.attr#windowSplitActionBar}
          attribute's value can be found in the {@link #ActionBarWindow} array.
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a ActionMenuItemView.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #ActionMenuItemView_android_minWidth ctec.example.blackjack:android_minWidth}</code></td><td></td></tr>
           </table>
        ...
        /**
          <p>This symbol is the offset where the {@link ctec.example.blackjack.R.attr#android_minWidth}
        ...
        */
        ...
        /** Attributes that can be used with a ActionMode.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #ActionMode_background ctec.example.blackjack:background}</code></td><td> Specifies a background for the action mode bar.</td></tr>
           <tr><td><code>{@link #ActionMode_backgroundSplit ctec.example.blackjack:backgroundSplit}</code></td><td> Specifies a background for the split action mode bar.</td></tr>
           <tr><td><code>{@link #ActionMode_height ctec.example.blackjack:height}</code></td><td> Specifies a fixed height for the action mode bar.</td></tr>
           <tr><td><code>{@link #ActionMode_subtitleTextStyle ctec.example.blackjack:subtitleTextStyle}</code></td><td> Specifies a style to use for subtitle text.</td></tr>
           <tr><td><code>{@link #ActionMode_titleTextStyle ctec.example.blackjack:titleTextStyle}</code></td><td> Specifies a style to use for title text.</td></tr>
           </table>
...
or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
        ...
        */
        ...
        /**  Attrbitutes for a ActivityChooserView. 
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #ActivityChooserView_expandActivityOverflowButtonDrawable ctec.example.blackjack:expandActivityOverflowButtonDrawable}</code></td><td> The drawable to show in the button for expanding the activities overflow popup.</td></tr>
           <tr><td><code>{@link #ActivityChooserView_initialActivityCount ctec.example.blackjack:initialActivityCount}</code></td><td> The maximal number of items initially shown in the activity list.</td></tr>
           </table>
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a CompatTextView.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #CompatTextView_textAllCaps ctec.example.blackjack:textAllCaps}</code></td><td> Present the text in ALL CAPS.</td></tr>
           </table>
...
<p>May be a boolean value, either "<code>true</code>" or "<code>false</code>".
        ...
        */
        ...
        /** Attributes that can be used with a LinearLayoutICS.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #LinearLayoutICS_divider ctec.example.blackjack:divider}</code></td><td> Drawable to use as a vertical divider between buttons.</td></tr>
           <tr><td><code>{@link #LinearLayoutICS_dividerPadding ctec.example.blackjack:dividerPadding}</code></td><td> Size of padding on either end of a divider.</td></tr>
           <tr><td><code>{@link #LinearLayoutICS_showDividers ctec.example.blackjack:showDividers}</code></td><td> Setting for which dividers to show.</td></tr>
           </table>
...
<tr><td><code>end</code></td><td>4</td><td></td></tr>
        ...
        */
        ...
        /**  Base attributes that are available to all groups. 
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #MenuGroup_android_checkableBehavior ctec.example.blackjack:android_checkableBehavior}</code></td><td> Whether the items are capable of displaying a check mark.</td></tr>
           <tr><td><code>{@link #MenuGroup_android_enabled ctec.example.blackjack:android_enabled}</code></td><td> Whether the items are enabled.</td></tr>
           <tr><td><code>{@link #MenuGroup_android_id ctec.example.blackjack:android_id}</code></td><td> The ID of the group.</td></tr>
           <tr><td><code>{@link #MenuGroup_android_menuCategory ctec.example.blackjack:android_menuCategory}</code></td><td> The category applied to all items within this group.</td></tr>
           <tr><td><code>{@link #MenuGroup_android_orderInCategory ctec.example.blackjack:android_orderInCategory}</code></td><td> The order within the category applied to all items within this group.</td></tr>
           <tr><td><code>{@link #MenuGroup_android_visible ctec.example.blackjack:android_visible}</code></td><td> Whether the items are shown/visible.</td></tr>
           </table>
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_checkableBehavior}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_enabled}.
        ...
        */
        ...
        /**
          ...
          @attr description
           The ID of the group. 
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_id}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_menuCategory}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_orderInCategory}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_visible}.
        ...
        */
        ...
        /**  Base attributes that are available to all Item objects. 
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #MenuItem_actionLayout ctec.example.blackjack:actionLayout}</code></td><td> An optional layout to be used as an action view.</td></tr>
           <tr><td><code>{@link #MenuItem_actionProviderClass ctec.example.blackjack:actionProviderClass}</code></td><td> The name of an optional ActionProvider class to instantiate an action view
             and perform operations such as default action for that menu item.</td></tr>
           <tr><td><code>{@link #MenuItem_actionViewClass ctec.example.blackjack:actionViewClass}</code></td><td> The name of an optional View class to instantiate and use as an
             action view.</td></tr>
           <tr><td><code>{@link #MenuItem_android_alphabeticShortcut ctec.example.blackjack:android_alphabeticShortcut}</code></td><td> The alphabetic shortcut key.</td></tr>
           <tr><td><code>{@link #MenuItem_android_checkable ctec.example.blackjack:android_checkable}</code></td><td> Whether the item is capable of displaying a check mark.</td></tr>
           <tr><td><code>{@link #MenuItem_android_checked ctec.example.blackjack:android_checked}</code></td><td> Whether the item is checked.</td></tr>
           <tr><td><code>{@link #MenuItem_android_enabled ctec.example.blackjack:android_enabled}</code></td><td> Whether the item is enabled.</td></tr>
           <tr><td><code>{@link #MenuItem_android_icon ctec.example.blackjack:android_icon}</code></td><td> The icon associated with this item.</td></tr>
           <tr><td><code>{@link #MenuItem_android_id ctec.example.blackjack:android_id}</code></td><td> The ID of the item.</td></tr>
           <tr><td><code>{@link #MenuItem_android_menuCategory ctec.example.blackjack:android_menuCategory}</code></td><td> The category applied to the item.</td></tr>
           <tr><td><code>{@link #MenuItem_android_numericShortcut ctec.example.blackjack:android_numericShortcut}</code></td><td> The numeric shortcut key.</td></tr>
           <tr><td><code>{@link #MenuItem_android_onClick ctec.example.blackjack:android_onClick}</code></td><td> Name of a method on the Context used to inflate the menu that will be
             called when the item is clicked.</td></tr>
           <tr><td><code>{@link #MenuItem_android_orderInCategory ctec.example.blackjack:android_orderInCategory}</code></td><td> The order within the category applied to the item.</td></tr>
           <tr><td><code>{@link #MenuItem_android_title ctec.example.blackjack:android_title}</code></td><td> The title associated with the item.</td></tr>
           <tr><td><code>{@link #MenuItem_android_titleCondensed ctec.example.blackjack:android_titleCondensed}</code></td><td> The condensed title associated with the item.</td></tr>
           <tr><td><code>{@link #MenuItem_android_visible ctec.example.blackjack:android_visible}</code></td><td> Whether the item is shown/visible.</td></tr>
           <tr><td><code>{@link #MenuItem_showAsAction ctec.example.blackjack:showAsAction}</code></td><td> How this item should display in the Action Bar, if present.</td></tr>
           </table>
...
containing a value of this type.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_alphabeticShortcut}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_checkable}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_checked}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_icon}.
        ...
        /**
          ...
          @attr description
           The numeric shortcut key.  This is the shortcut when using a numeric (e.g., 12-key)
             keyboard. 
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_numericShortcut}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_onClick}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_title}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_titleCondensed}.
...
<tr><td><code>collapseActionView</code></td><td>8</td><td> This item's action view collapses to a normal menu
        ...
        */
        ...
        /** Attributes that can be used with a MenuView.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #MenuView_android_headerBackground ctec.example.blackjack:android_headerBackground}</code></td><td> Default background for the menu header.</td></tr>
           <tr><td><code>{@link #MenuView_android_horizontalDivider ctec.example.blackjack:android_horizontalDivider}</code></td><td> Default horizontal divider between rows of menu items.</td></tr>
           <tr><td><code>{@link #MenuView_android_itemBackground ctec.example.blackjack:android_itemBackground}</code></td><td> Default background for each menu item.</td></tr>
           <tr><td><code>{@link #MenuView_android_itemIconDisabledAlpha ctec.example.blackjack:android_itemIconDisabledAlpha}</code></td><td> Default disabled icon alpha for each menu item that shows an icon.</td></tr>
           <tr><td><code>{@link #MenuView_android_itemTextAppearance ctec.example.blackjack:android_itemTextAppearance}</code></td><td> Default appearance of menu item text.</td></tr>
           <tr><td><code>{@link #MenuView_android_preserveIconSpacing ctec.example.blackjack:android_preserveIconSpacing}</code></td><td> Whether space should be reserved in layout when an icon is missing.</td></tr>
           <tr><td><code>{@link #MenuView_android_verticalDivider ctec.example.blackjack:android_verticalDivider}</code></td><td> Default vertical divider between menu items.</td></tr>
           <tr><td><code>{@link #MenuView_android_windowAnimationStyle ctec.example.blackjack:android_windowAnimationStyle}</code></td><td> Default animations for the menu.</td></tr>
           </table>
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_headerBackground}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_horizontalDivider}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_itemBackground}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_itemIconDisabledAlpha}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_itemTextAppearance}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_verticalDivider}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_windowAnimationStyle}.
        ...
        */
        ...
        /** Attributes that can be used with a SearchView.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #SearchView_android_imeOptions ctec.example.blackjack:android_imeOptions}</code></td><td> The IME options to set on the query text field.</td></tr>
           <tr><td><code>{@link #SearchView_android_inputType ctec.example.blackjack:android_inputType}</code></td><td> The input type to set on the query text field.</td></tr>
           <tr><td><code>{@link #SearchView_android_maxWidth ctec.example.blackjack:android_maxWidth}</code></td><td> An optional maximum width of the SearchView.</td></tr>
           <tr><td><code>{@link #SearchView_iconifiedByDefault ctec.example.blackjack:iconifiedByDefault}</code></td><td> The default state of the SearchView.</td></tr>
           <tr><td><code>{@link #SearchView_queryHint ctec.example.blackjack:queryHint}</code></td><td> An optional query hint string to be displayed in the empty query field.</td></tr>
           </table>
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_imeOptions}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_inputType}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_maxWidth}.
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a Spinner.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #Spinner_android_dropDownHorizontalOffset ctec.example.blackjack:android_dropDownHorizontalOffset}</code></td><td> Horizontal offset from the spinner widget for positioning the dropdown
             in spinnerMode="dropdown".</td></tr>
           <tr><td><code>{@link #Spinner_android_dropDownSelector ctec.example.blackjack:android_dropDownSelector}</code></td><td> List selector to use for spinnerMode="dropdown" display.</td></tr>
           <tr><td><code>{@link #Spinner_android_dropDownVerticalOffset ctec.example.blackjack:android_dropDownVerticalOffset}</code></td><td> Vertical offset from the spinner widget for positioning the dropdown in
             spinnerMode="dropdown".</td></tr>
           <tr><td><code>{@link #Spinner_android_dropDownWidth ctec.example.blackjack:android_dropDownWidth}</code></td><td> Width of the dropdown in spinnerMode="dropdown".</td></tr>
           <tr><td><code>{@link #Spinner_android_gravity ctec.example.blackjack:android_gravity}</code></td><td> Gravity setting for positioning the currently selected item.</td></tr>
           <tr><td><code>{@link #Spinner_android_popupBackground ctec.example.blackjack:android_popupBackground}</code></td><td> Background drawable to use for the dropdown in spinnerMode="dropdown".</td></tr>
           <tr><td><code>{@link #Spinner_disableChildrenWhenDisabled ctec.example.blackjack:disableChildrenWhenDisabled}</code></td><td> Whether this spinner should mark child views as enabled/disabled when
             the spinner itself is enabled/disabled.</td></tr>
           <tr><td><code>{@link #Spinner_popupPromptView ctec.example.blackjack:popupPromptView}</code></td><td> Reference to a layout to use for displaying a prompt in the dropdown for
             spinnerMode="dropdown".</td></tr>
           <tr><td><code>{@link #Spinner_prompt ctec.example.blackjack:prompt}</code></td><td> The prompt to display when the spinner's dialog is shown.</td></tr>
           <tr><td><code>{@link #Spinner_spinnerMode ctec.example.blackjack:spinnerMode}</code></td><td> Display mode for spinner options.</td></tr>
           </table>
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_dropDownHorizontalOffset}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_dropDownSelector}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_dropDownVerticalOffset}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_dropDownWidth}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_gravity}.
        ...
        */
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_popupBackground}.
...
<tr><td><code>dropdown</code></td><td>1</td><td> Spinner options will be presented to the user as an inline dropdown
        ...
        */
        ...
        /**  These are the standard attributes that make up a complete theme. 
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #Theme_actionDropDownStyle ctec.example.blackjack:actionDropDownStyle}</code></td><td> Default ActionBar dropdown style.</td></tr>
           <tr><td><code>{@link #Theme_dropdownListPreferredItemHeight ctec.example.blackjack:dropdownListPreferredItemHeight}</code></td><td> The preferred item height for dropdown lists.</td></tr>
           <tr><td><code>{@link #Theme_listChoiceBackgroundIndicator ctec.example.blackjack:listChoiceBackgroundIndicator}</code></td><td> Drawable used as a background for selected list items.</td></tr>
           <tr><td><code>{@link #Theme_panelMenuListTheme ctec.example.blackjack:panelMenuListTheme}</code></td><td> Default Panel Menu style.</td></tr>
           <tr><td><code>{@link #Theme_panelMenuListWidth ctec.example.blackjack:panelMenuListWidth}</code></td><td> Default Panel Menu width.</td></tr>
           <tr><td><code>{@link #Theme_popupMenuStyle ctec.example.blackjack:popupMenuStyle}</code></td><td> Default PopupMenu style.</td></tr>
           </table>
...
or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
        ...
        */
        ...
        /** Attributes that can be used with a View.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #View_android_focusable ctec.example.blackjack:android_focusable}</code></td><td> Boolean that controls whether a view can take focus.</td></tr>
           <tr><td><code>{@link #View_paddingEnd ctec.example.blackjack:paddingEnd}</code></td><td> Sets the padding, in pixels, of the end edge; see {@link android.R.attr#padding}.</td></tr>
           <tr><td><code>{@link #View_paddingStart ctec.example.blackjack:paddingStart}</code></td><td> Sets the padding, in pixels, of the start edge; see {@link android.R.attr#padding}.</td></tr>
           </table>
        ...
        /**
          ...
          <p>This corresponds to the global attribute          resource symbol {@link ctec.example.blackjack.R.attr#android_focusable}.
